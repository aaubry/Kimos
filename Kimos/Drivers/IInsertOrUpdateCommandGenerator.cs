...
{
    public interface IInsertOrUpdateCommandGenerator
    {
        string GenerateSqlCommand<TEntity, TParams, TResult>(IInsertOrUpdateCommand<TEntity, TParams, TResult> command, IQueryMetadata metadata);
    }
}
