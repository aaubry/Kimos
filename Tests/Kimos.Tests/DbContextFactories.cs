...
{
    public class DbContextFactories : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[] { new SqlServer.DesignTimeDbContextFactory() };
            yield return new object[] { new PostgreSql.DesignTimeDbContextFactory() };
        }
