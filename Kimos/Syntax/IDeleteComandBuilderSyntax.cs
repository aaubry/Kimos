...
{
    public interface IDeleteComandBuilderSyntax<TEntity, TParams> : ICommandTextBuilderSyntax
    {
        /// <summary>
        ...
        /// <returns>Returns a command executor that can be used one or many times with different parameters.</returns>
