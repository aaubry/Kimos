...
{
    public interface IOutputComandBuilderSyntax<TEntity, TParams, TResult> : ICommandTextBuilderSyntax
    {
        /// <summary>
        /// Creates a command executor for the current command.
        /// </summary>
        /// <param name="context">The <see cref="DbContext" /> on which the command will be executed.</param>
        IUnpreparedOutputComandBuilderSyntax<TEntity, TParams, TResult> Create(DbContext context);
    }
}