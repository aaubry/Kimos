...
{
    public interface ICommandTextBuilderSyntax
    {
        /// <summary>
        /// Generates the SQL code of the current command.
        /// </summary>
        /// <param name="context">The <see cref="DbContext" /> for which the code is to be generated.</param>
        /// <returns>Returns a string containing the SQL code for the command.</returns>
        string BuildCommandText(DbContext context);
    }
}